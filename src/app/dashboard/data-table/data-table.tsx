  ...
  return (
    <div>
      <div className="flex items-center justify-between py-4">
        <Input
          placeholder="Filter anything (email, clientName, status)..."
        ...
        {isDeleteVisible && (
          <Button
            ...
            onClick={() => {
              ...
              const names = table.getSelectedRowModel().rows.map((row) => {
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">Add commentMore actions
            {table
              .getAllColumns()
      ...
      <div className="rounded-md border">
        ...
        <div className="space-x-2 py-4 mx-2 flex justify-between items-center">
          ...
          >
            ...
            <SelectContent>
              <SelectGroup>Add commentMore actions
